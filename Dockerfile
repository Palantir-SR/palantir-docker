...
LABEL description="Container for use with Palantir"
...
ENV PALANTIR_CODE_ROOT /workspace/palantir
ENV PALANTIR_DATA_ROOT /workspace/palantir-data
ENV SNPE_ROOT $PALANTIR_CODE_ROOT/third_party/snpe
ENV PYTHONPATH  $PALANTIR_CODE_ROOT:$SNPE_ROOT/lib/python:$PYTHONPATH
